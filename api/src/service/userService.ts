...
export class UserService {
  ...
  createUser(user: { nome: string; telefone: string; email: string; senha: string; idade?: number }): User {
    const userCreated = User.create(user.nome, user.telefone, user.email, user.senha, user.idade);
  ...
  getUsersByIdade(idade: number): User | undefined {
